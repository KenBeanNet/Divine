...
public class EntityAIStatueArrowAttack extends EntityAIBase
{
    World worldObj;
    ...
    public EntityAIStatueArrowAttack(EntityLiving var1, float var2, int var3, int var4)
    {
    ...
    {
        EntityLivingStatueArrow var1 = new EntityLivingStatueArrow(this.worldObj, this.entityHost, this.attackTarget, 1.6F, 12.0F);
