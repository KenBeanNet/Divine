...
public class ItemEnderBow extends ItemBow
{
    ...
    public void onPlayerStoppedUsing(ItemStack var1, World var2, EntityPlayer var3, int var4)
    {
        ...
        if (!var6.isCanceled())
        {
            ...
            if (var7 || var3.inventory.hasItem(Item.arrow.itemID))
            {
                ...
                EntityEnderArrow var9 = new EntityEnderArrow(var2, var3, var8 * 2.0F);
                ...
                if (var10 > 0)
                {
                    var9.setDamage((var9.getDamage() + (double)var10 * 0.5D + 0.5D) * 2.0D);
                }
