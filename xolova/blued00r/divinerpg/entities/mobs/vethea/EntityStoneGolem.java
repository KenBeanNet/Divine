...
public class EntityStoneGolem extends EntityTameable
{
    ...
    {
        super(var1);
        this.texture = "/mob/StoneGolem.png";
    ...
    {
        int var2 = this.getDamage();
        var1.addVelocity((double)(-MathHelper.sin(this.rotationYaw * (float)Math.PI / 180.0F) * 3.0F * 0.5F), 0.1D, (double)(MathHelper.cos(this.rotationYaw * (float)Math.PI / 180.0F) * 3.0F * 0.5F));
        this.motionX *= 0.6D;
        this.motionZ *= 0.6D;
    ...
    public boolean interact(EntityPlayer var1)
    {
        ...
        else if (var2 != null && var2.itemID == DivineRPG.rockChunks.itemID && !this.isAngry())
        {
            if (!var1.capabilities.isCreativeMode)
            {
                --var2.stackSize;
    ...
    {
        EntityStoneGolem var2 = new EntityStoneGolem(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal var1)
    {
        ...
        else if (!(var1 instanceof EntityStoneGolem))
        {
            return false;
        }
        else
        {
            EntityStoneGolem var2 = (EntityStoneGolem)var1;
    ...
    public boolean getCanSpawnHere()
    {
        ...
        return this.getBlockPathWeight(var1, var2, var3) >= 0.0F && this.worldObj.checkIfAABBIsClear(this.boundingBox) && this.worldObj.getCollidingBoundingBoxes(this, this.boundingBox).isEmpty() && !this.worldObj.isAnyLiquid(this.boundingBox);
    }
