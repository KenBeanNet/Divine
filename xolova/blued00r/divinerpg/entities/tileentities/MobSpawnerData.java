...
class MobSpawnerData extends WeightedRandomItem
{
    ...
    public MobSpawnerData(TileEntityGlacideSpawner var1, NBTTagCompound var2)
    {
    ...
    public MobSpawnerData(TileEntityGlacideSpawner var1, NBTTagCompound var2, String var3)
    {
        super(1);
        this.field_92031_d = var1;
