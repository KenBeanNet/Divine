...
public class ModelRollum extends ModelBase
{
    ...
    public ModelRollum()
    {
        ...
        this.head.setRotationPoint(0.0F, 5.0F, -10.0F);
        this.head.setTextureSize(64, 32);
        this.head.mirror = true;
        this.setRotation(this.head, 0.0F, 0.0F, 0.0F);
        this.connector = new ModelRenderer(this, 30, 14);
        this.connector.addBox(-4.0F, 0.0F, -2.0F, 4, 4, 4);
        this.connector.setRotationPoint(2.0F, 1.0F, -2.0F);
        this.connector.setTextureSize(64, 32);
        this.connector.mirror = true;
        this.setRotation(this.connector, -((float)Math.PI / 2F), 0.0F, 0.0F);
        this.rightarmtop = new ModelRenderer(this, 36, 16);
        ...
        this.leftarmext = new ModelRenderer(this, 30, 18);
        this.leftarmext.addBox(0.0F, 9.0F, -10.0F, 4, 5, 9);
        this.leftarmext.setRotationPoint(7.0F, -5.0F, -1.0F);
        ...
        this.rightarmext = new ModelRenderer(this, 30, 18);
        this.rightarmext.addBox(-5.0F, 9.0F, -10.0F, 4, 5, 9);
        this.rightarmext.setRotationPoint(-6.0F, -5.0F, -1.0F);
