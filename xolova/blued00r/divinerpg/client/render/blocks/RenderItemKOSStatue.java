...
import xolova.blued00r.divinerpg.client.render.blocks.RenderItemKOSStatue$1;

public class RenderItemKOSStatue implements IItemRenderer
{
    private ModelKOSStatue dramixAltar = new ModelKOSStatue();
    ...
    {
        switch (RenderItemKOSStatue$1.$SwitchMap$net$minecraftforge$client$IItemRenderer$ItemRenderType[var1.ordinal()])
        {
            case 1:
    ...
    {
        ForgeHooksClient.bindTexture("/DivineRPG/StatueKOS.png", 0);
        GL11.glPushMatrix();
