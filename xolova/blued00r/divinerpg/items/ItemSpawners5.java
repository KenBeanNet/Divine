...
public class ItemSpawners5 extends Item
{
    private World worldObj;

    public ItemSpawners5(int var1)
    {
        super(var1);
        this.maxStackSize = 1;
    }
    ...
    {
        Entity var8 = EntityList.createEntityByID(113, var0);
        Entity var9 = EntityList.createEntityByID(114, var0);

        if (var8 != null && var0.getBiomeGenForCoords((int)var2, (int)var6) == DivineRPG.denseBiome)
        {
            var8.setLocationAndAngles(var2, var4, var6, var0.rand.nextFloat() * 360.0F, 0.0F);
            var0.spawnEntityInWorld(var8);
            var0.playSoundAtEntity(var8, "mob.RPG.DexZichileSpawn", 10.0F, 1.0F);
        }

        if (var9 != null && var0.getBiomeGenForCoords((int)var2, (int)var6) == DivineRPG.denseBiome)
        {
            var9.setLocationAndAngles(var2, var4, var6, var0.rand.nextFloat() * 360.0F, 0.0F);
            var0.spawnEntityInWorld(var9);
        }

        return var8 != null && var9 != null;
    }
