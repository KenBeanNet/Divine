...
public class GuiSuperEnchant extends GuiContainer
{
    private static ModelBook bookModel = new ModelBook();
    private Random rand = new Random();
    private ContainerSuperEnchant containerEnchantment;
    ...
    public GuiSuperEnchant(InventoryPlayer var1, World var2, int var3, int var4, int var5)
    {
        super(new ContainerSuperEnchant(var1, var2, var3, var4, var5));
