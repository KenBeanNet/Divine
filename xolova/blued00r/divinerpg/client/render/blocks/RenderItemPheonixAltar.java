...
import xolova.blued00r.divinerpg.client.render.blocks.RenderItemPheonixAltar$1;

public class RenderItemPheonixAltar implements IItemRenderer
{
    private ModelPhoenixAltar dramixAltar = new ModelPhoenixAltar(0.0625F);
    ...
    {
        switch (RenderItemPheonixAltar$1.$SwitchMap$net$minecraftforge$client$IItemRenderer$ItemRenderType[var1.ordinal()])
        {
            case 1:
    ...
    {
        ForgeHooksClient.bindTexture("/DivineRPG/PhoenixSpawn.png", 0);
        GL11.glPushMatrix();
