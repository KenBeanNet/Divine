...
{
    public BlockPinfly(int var1, int var2)
    {
    ...
    {
        if (this.blockID == DivineRPG.pinFly.blockID)
        {
            var1.setBlockWithNotify(var2, var3 + 1, var4, DivineRPG.pinFly2.blockID);
        }
    }
    ...
    {
        return this.blockID == DivineRPG.pinFly2.blockID ? DivineRPG.pinFlyItem.itemID : 0;
    }
