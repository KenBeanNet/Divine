...
public class EntityEnergyArrow extends Entity
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityEnergyArrow(World var1, EntityLiving var2, float var3)
    {
        super(var1);
        this.shootingEntity = var2;
    ...
    public static DamageSource causeSerenityArrowDamage(EntityEnergyArrow var0, Entity var1)
    {
        return (new EntityDamageSourceIndirect("energyarrow", var0, var1)).setProjectile();
    }
