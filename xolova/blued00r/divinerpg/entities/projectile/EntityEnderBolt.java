...
public class EntityEnderBolt extends Entity
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityEnderBolt(World var1)
    {
        super(var1);
        this.setSize(0.5F, 0.5F);
    }

    public EntityEnderBolt(World var1, double var2, double var4, double var6)
    {
        super(var1);
        this.setSize(0.5F, 0.5F);
    ...
    public EntityEnderBolt(World var1, EntityLiving var2, float var3)
    {
        super(var1);
        ...
        else
        {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    int var22 = (int)Math.ceil((double)var20 * 2.0D);
                    ...
                    {
                        var24 = causeFireArrowDamage(this, this);
                    }
                    else
                    {
                        var24 = causeFireArrowDamage(this, this.shootingEntity);
                    }

                    if (var4.entityHit.attackEntityFrom(var24, var22))
                    {
    ...
    public static DamageSource causeFireArrowDamage(EntityEnderBolt var0, Entity var1)
    {
        return (new EntityDamageSourceIndirect("fireball", var0, var1)).setProjectile();
    }
