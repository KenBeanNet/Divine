...
public class GuiCaptainMerik extends GuiContainer
{
    ...
    {
        this.fontRenderer.drawString(StatCollector.translateToLocal("Captian Merik"), 56, 6, 4210752);
    ...
    {
        int var4 = this.mc.renderEngine.getTexture("/gui/CaptainMerik.png");
