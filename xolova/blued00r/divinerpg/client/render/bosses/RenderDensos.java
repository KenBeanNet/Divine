...
public class RenderDensos extends RenderLiving
{
    protected ModelDensos modelBipedMain;
    protected float field_77070_b;

    public RenderDensos(ModelDensos var1, float var2)
    {
        this(var1, var2, 1.0F);
        this.modelBipedMain = var1;
    }

    public RenderDensos(ModelDensos var1, float var2, float var3)
    {
        super(var1, var2);
        this.modelBipedMain = var1;
    ...
    {
        this.func_48421_a((EntityDensos)var1, var2, var4, var6, var8, var9);
    }

    public void func_48421_a(EntityDensos var1, double var2, double var4, double var6, float var8, float var9)
    {
        BossStatus.func_82824_a(var1, true);
        super.doRenderLiving(var1, var2, var4, var6, var8, var9);
    }

    public void doRenderLiving(EntityDensos var1, double var2, double var4, double var6, float var8, float var9)
    {
