...
public class EntityMamormeter extends EntityMob implements IBossDisplayData
{
    ...
    protected void updateAITasks()
    {
        ...
        if (this.special > 0 && this.getAttackTarget() != null)
        {
            ...
            if (this.special % 5 == 0)
            {
                EntityMamormeterShot var1 = new EntityMamormeterShot(this.worldObj, this.getAttackTarget().posX, this.getAttackTarget().posY + 10.0D, this.getAttackTarget().posZ, true);
                var1.setVelocity(0.0D, -0.5D, 0.0D);
