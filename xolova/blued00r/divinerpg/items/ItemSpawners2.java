...
public class ItemSpawners2 extends Item
{
    private World worldObj;

    public ItemSpawners2(int var1)
    {
        super(var1);
        this.maxStackSize = 1;
    }
    ...
    {
        Entity var8 = EntityList.createEntityByID(117, var0);
        ...
        if (var8 != null && var0.getBiomeGenForCoords((int)var2, (int)var6) == DivineRPG.denseBiome)
        {
            ...
            var0.playSoundAtEntity(var8, "mob.RPG.TwilightDemonSpawn", 10.0F, 1.0F);
        }
