...
public class GuiTinkerer extends GuiContainer
{
    ...
    {
        this.fontRenderer.drawString(StatCollector.translateToLocal("Tinkerer"), 56, 6, 4210752);
    ...
    protected void actionPerformed(GuiButton var1)
    {
        ...
        if (var2)
        {
            ((ContainerTinkerer)this.inventorySlots).setCurrentRecipeIndex(this.currentRecipeIndex);
