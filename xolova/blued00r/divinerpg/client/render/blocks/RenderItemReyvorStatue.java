...
import xolova.blued00r.divinerpg.client.models.ModelReyvorStatue;
import xolova.blued00r.divinerpg.client.render.blocks.RenderItemReyvorStatue$1;

public class RenderItemReyvorStatue implements IItemRenderer
{
    private ModelReyvorStatue dramixAltar = new ModelReyvorStatue();
    ...
    {
        switch (RenderItemReyvorStatue$1.$SwitchMap$net$minecraftforge$client$IItemRenderer$ItemRenderType[var1.ordinal()])
        {
            case 1:
