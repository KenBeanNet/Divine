...
public class WorldGenLayer3BigTree extends WorldGenerator
{
    ...
    int heightLimit = 0;
    int height;
    double heightAttenuation = 0.918D;
    double branchDensity = 1.0D;
    double branchSlope = -0.681D;
    double scaleWidth = 3.0D;
    double leafDensity = 0.3D;
    int trunkSize = 1;
    int heightLimitLimit = 32;
    int leafDistanceLimit = 4;
    int[][] leafNodes;

    public WorldGenLayer3BigTree(boolean var1)
    {
        super(var1);
    }
        ...
        for (var11[var5] = var10[var5]; var12 <= var7; ++var12)
        {
            ...
            while (var13 <= var7)
            {
                ...
                else
                {
                    ...
                    if (var16 != 0 && var16 != DivineRPG.dreamwoodLeaves.blockID)
                    {
                        ++var13;
                    }
                    else
    ...
    void generateLeafNode(int var1, int var2, int var3)
    {
        ...
        for (int var5 = var2 + this.leafDistanceLimit; var4 < var5; ++var4)
        {
            ...
            this.genTreeLayer(var1, var4, var3, var6, (byte)1, DivineRPG.dreamwoodLeaves.blockID);
        }
    }
    ...
    void generateTrunk()
    {
        ...
        this.placeBlockLine(var5, var6, DivineRPG.dreamwood.blockID);
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] var3 = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; var1 < var2; ++var1)
        {
            ...
            {
                this.placeBlockLine(var3, var5, (byte)DivineRPG.dreamwood.blockID);
            }
        }
    }
