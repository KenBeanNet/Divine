...
import xolova.blued00r.divinerpg.client.render.blocks.RenderItemVamacheronStatue$1;

public class RenderItemVamacheronStatue implements IItemRenderer
{
    private ModelVamacheronStatue dramixAltar = new ModelVamacheronStatue();
    ...
    {
        switch (RenderItemVamacheronStatue$1.$SwitchMap$net$minecraftforge$client$IItemRenderer$ItemRenderType[var1.ordinal()])
        {
            case 1:
    ...
    {
        ForgeHooksClient.bindTexture("/DivineRPG/StatueVamacheron.png", 0);
        GL11.glPushMatrix();
