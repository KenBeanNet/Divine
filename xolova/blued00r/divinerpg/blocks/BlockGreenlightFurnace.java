...
public class BlockGreenlightFurnace extends BlockContainer
{
    private Random furnaceRand = new Random();
    private final boolean isActive;
    private static boolean keepFurnaceInventory = false;

    public BlockGreenlightFurnace(int var1, boolean var2)
    {
    ...
    {
        return DivineRPG.moltenFurnace.blockID;
    }
    ...
    public boolean onBlockActivated(World var1, int var2, int var3, int var4, EntityPlayer var5, int var6, float var7, float var8, float var9)
    {
        ...
        {
            TileEntityGreenlightFurnace var10 = (TileEntityGreenlightFurnace)var1.getBlockTileEntity(var2, var3, var4);

            if (var10 != null)
            {
                var5.openGui(DivineRPG.instance, 2, var1, var2, var3, var4);
            }
    ...
    public static void updateFurnaceBlockState(boolean var0, World var1, int var2, int var3, int var4)
    {
        ...
        if (var0)
        {
            var1.setBlockWithNotify(var2, var3, var4, DivineRPG.greenlightFurnaceOn.blockID);
        }
        else
        {
            var1.setBlockWithNotify(var2, var3, var4, DivineRPG.greenlightFurnace.blockID);
        }
    ...
    public void breakBlock(World var1, int var2, int var3, int var4, int var5, int var6)
    {
        ...
        {
            TileEntityGreenlightFurnace var7 = (TileEntityGreenlightFurnace)var1.getBlockTileEntity(var2, var3, var4);
