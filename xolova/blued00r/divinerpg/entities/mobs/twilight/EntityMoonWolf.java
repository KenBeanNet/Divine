...
public class EntityMoonWolf extends EntityTameable
{
    ...
    public boolean getCanSpawnHere()
    {
        ...
        return this.worldObj.getBlockId(var1, var2 - 1, var3) == DivineRPG.azuriteGrass.blockID && this.getBlockPathWeight(var1, var2, var3) >= 0.0F && this.worldObj.checkIfAABBIsClear(this.boundingBox) && this.worldObj.getCollidingBoundingBoxes(this, this.boundingBox).isEmpty() && !this.worldObj.isAnyLiquid(this.boundingBox);
    }
