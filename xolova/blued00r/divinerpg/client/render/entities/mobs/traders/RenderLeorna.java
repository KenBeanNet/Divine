...
{
    public RenderLeorna(ModelLeorna var1, float var2)
    {
        super(var1, var2);
    }

    public void renderLeorna(EntityLeorna var1, double var2, double var4, double var6, float var8, float var9)
    {
    ...
    {
        this.renderLeorna((EntityLeorna)var1, var2, var4, var6, var8, var9);
    }
