...
public class BlockEnderPumpkin extends Block
{
    public BlockEnderPumpkin(int var1)
    {
    ...
    {
        return var1 == 1 ? 145 : (var1 == 0 ? 145 : (var1 == 3 ? this.blockIndexInTexture - 1 : this.blockIndexInTexture));
    }
