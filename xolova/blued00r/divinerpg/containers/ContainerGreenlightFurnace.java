...
public class ContainerGreenlightFurnace extends Container
{
    private TileEntityGreenlightFurnace furnace;
    private int lastCookTime = 0;
    private int lastBurnTime = 0;
    private int lastItemBurnTime = 0;

    public ContainerGreenlightFurnace(InventoryPlayer var1, TileEntityGreenlightFurnace var2)
    {
        this.furnace = var2;
    ...
    public ItemStack transferStackInSlot(EntityPlayer var1, int var2)
    {
        ...
        if (var4 != null && var4.getHasStack())
        {
            ...
            else if (var2 != 1 && var2 != 0)
            {
                ...
                else if (TileEntityGreenlightFurnace.isItemFuel(var5))
                {
