...
import xolova.blued00r.divinerpg.client.render.blocks.RenderItemParasectaStatue$1;

public class RenderItemParasectaStatue implements IItemRenderer
{
    private ModelParasecta dramixAltar = new ModelParasecta();
    ...
    {
        switch (RenderItemParasectaStatue$1.$SwitchMap$net$minecraftforge$client$IItemRenderer$ItemRenderType[var1.ordinal()])
        {
            case 1:
    ...
    {
        ForgeHooksClient.bindTexture("/DivineRPG/StatueParasecta.png", 0);
        GL11.glPushMatrix();
