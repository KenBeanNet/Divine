...
public class RenderWilfFire extends RenderLiving
{
    ...
    public RenderWilfFire(ModelWildFire var1, float var2)
    {
        this(var1, var2, 1.0F);
        this.modelBipedMain = var1;
    }

    public RenderWilfFire(ModelWildFire var1, float var2, float var3)
    {
        super(var1, var2);
        this.modelBipedMain = var1;
    ...
    protected void renderEquippedItems(EntityLiving var1, float var2)
    {
        ...
        if (var3 != null)
        {
            ...
            if (var3.itemID == DivineRPG.infernoBow.itemID)
            {
                float var7 = 0.625F;
