...
public class TileEntityCoalStoneFurnace extends TileEntity implements IInventory, ISidedInventory
{
    ...
    {
        return this.furnaceCookTime * var1 / 1000;
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                var2 = true;
                BlockIceikaFurnace.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
