...
import xolova.blued00r.divinerpg.client.render.blocks.RenderItemDramixStatue$1;

public class RenderItemDramixStatue implements IItemRenderer
{
    private ModelDramixStatue dramixAltar = new ModelDramixStatue();
    ...
    {
        switch (RenderItemDramixStatue$1.$SwitchMap$net$minecraftforge$client$IItemRenderer$ItemRenderType[var1.ordinal()])
        {
            case 1:
