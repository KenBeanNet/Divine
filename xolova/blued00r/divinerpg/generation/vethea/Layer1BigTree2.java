...
public class Layer1BigTree2 extends WorldGenerator
{
    ...
    double branchSlope = 1.81D;
    double scaleWidth = 2.0D;
    double leafDensity = 9.262D;
    int trunkSize = 1;
    int heightLimitLimit = 23;
    int leafDistanceLimit = 2;
    int[][] leafNodes;

    public Layer1BigTree2(boolean var1)
    {
        super(var1);
    }
