...
public class TileEntityGreenlightFurnace extends TileEntityFurnace implements IInventory, ISidedInventory
{
    ...
    {
        return this.furnaceCookTime * var1 / 143;
    }
    ...
    public static int getItemBurnTime(ItemStack var0)
    {
        ...
        else
        {
            ...
            return var1 == DivineRPG.fireStockItem.itemID ? 300 : 0;
        }
    }
