...
public class GuiHungerHungry extends GuiContainer
{
    ...
    protected void actionPerformed(GuiButton var1)
    {
        ...
        if (var2)
        {
            ((ContainerHungerHungry)this.inventorySlots).setCurrentRecipeIndex(this.currentRecipeIndex);
    ...
    {
        int var4 = this.mc.renderEngine.getTexture("/gui/Hunger.png");
