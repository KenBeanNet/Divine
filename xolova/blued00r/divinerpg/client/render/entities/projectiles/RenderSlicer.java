...
public class RenderSlicer extends Render
{
    private int itemIconIndex;

    public RenderSlicer(int var1)
    {
    ...
    public void doRender(Entity var1, double var2, double var4, double var6, float var8, float var9)
    {
        ...
        if (this.itemIconIndex == 31)
        {
            this.loadTexture("/Xolovon1.png");
        }

        if (this.itemIconIndex == 144)
        {
            this.loadTexture("/Xolovon1.png");
        }

        if (this.itemIconIndex == 145)
        {
            this.loadTexture("/Xolovon1.png");
        }

        if (this.itemIconIndex == 102)
        {
            this.loadTexture("/Xolovon1.png");
        }

        if (this.itemIconIndex == 71)
        {
            this.loadTexture("/Xolovon1.png");
        }

        if (this.itemIconIndex == 72)
        {
            this.loadTexture("/Xolovon1.png");
        }

        if (this.itemIconIndex == 73)
        {
            this.loadTexture("/Xolovon1.png");
        }

        if (this.itemIconIndex == 124)
        {
