...
public class EntitySerenityBunny extends EntityTameable
{
    ...
    public EntitySerenityBunny(World var1, boolean var2, String var3)
    {
        this(var1);
        this.setTamed(var2);
        this.setOwner(var3);
    ...
    public void onDeath(DamageSource var1)
    {
        ...
        if (!this.worldObj.isRemote && !this.isTamed())
        {
            ...
            {
                ((EntityPlayer)var2).addStat(AchievementPageDivineRPG.friendOrFoe, 1);
            }

            this.transform(false, var2);
        }
    }
    ...
    public boolean attackEntityAsMob(Entity var1)
    {
        if (this.isTamed())
        {
            this.transform(true, var1);
            return false;
        }
        else
        {
            return var1.attackEntityFrom(DamageSource.causeMobDamage(this), this.getAttackStrength(var1));
        }
    }
    ...
    private void transform(boolean var1, Entity var2)
    {
        if (!this.worldObj.isRemote)
        {
            EntityAngryBunny var3 = new EntityAngryBunny(this.worldObj, var1, this.getOwnerName());
            var3.setLocationAndAngles(this.posX, this.posY, this.posZ, this.rotationYaw, this.rotationPitch);
            this.worldObj.spawnEntityInWorld(var3);

            if (var2 instanceof EntityLiving)
            {
                var3.setAttackTarget((EntityLiving)var2);
            }
    ...
    public boolean interact(EntityPlayer var1)
    {
        ...
        else if (var2 != null && var2.itemID == DivineRPG.draviteSparkles.itemID)
        {
            if (!var1.capabilities.isCreativeMode)
            {
                --var2.stackSize;
