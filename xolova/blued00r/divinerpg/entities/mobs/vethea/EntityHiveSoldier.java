...
public class EntityHiveSoldier extends EntityMob
{
    public EntityHiveSoldier(World var1)
    {
        super(var1);
        this.texture = "/mob/HiveSoldier.png";
    ...
    public boolean attackEntityAsMob(Entity var1)
    {
        ...
        if (var1 instanceof EntityLiving)
        {
            ...
            ((EntityLiving)var1).addPotionEffect(new PotionEffect(Potion.poison.id, 32, 0));
        }
