...
public class EntityBowCannon extends EntityThrowable
{
    public EntityBowCannon(World var1)
    {
        super(var1);
    }
    ...
    public EntityBowCannon(World var1, double var2, double var4, double var6)
    {
