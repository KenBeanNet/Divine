...
public class ItemPhasersEnergy extends Item
{
    private int damage;
    ...
    public ItemPhasersEnergy(int var1, int var2, int var3, int var4, String var5, String var6)
    {
        super(var1);
        this.damage = var2;
        this.firemax = var4;
    ...
    public ItemStack onItemRightClick(ItemStack var1, World var2, EntityPlayer var3)
    {
        if (!var2.isRemote)
        {
            ...
            {
                var2.spawnEntityInWorld(new EntityEnergyPhaser(var2, var3));
