...
public class BlockIceikaFurnace extends BlockContainer
{
    private Random furnaceRand = new Random();
    private final boolean isActive;
    private static boolean keepFurnaceInventory = false;

    public BlockIceikaFurnace(int var1, boolean var2)
    {
        super(var1, Material.rock);
        this.isActive = var2;
        this.blockIndexInTexture = 190;
    }
    ...
    {
        return DivineRPG.iceikaFurnace.blockID;
    }
    ...
    public int getBlockTexture(IBlockAccess var1, int var2, int var3, int var4, int var5)
    {
        ...
        else
        {
            ...
            return var5 != var6 ? this.blockIndexInTexture : (this.isActive ? this.blockIndexInTexture + 1 : this.blockIndexInTexture - 1);
        }
    }
    ...
    {
        return var1 == 1 ? this.blockIndexInTexture + 2 : (var1 == 0 ? this.blockIndexInTexture + 2 : (var1 == 3 ? this.blockIndexInTexture - 1 : this.blockIndexInTexture));
    }
    ...
    public boolean onBlockActivated(World var1, int var2, int var3, int var4, EntityPlayer var5, int var6, float var7, float var8, float var9)
    {
        ...
        {
            TileEntityCoalStoneFurnace var10 = (TileEntityCoalStoneFurnace)var1.getBlockTileEntity(var2, var3, var4);

            if (var10 != null)
            {
                var5.openGui(DivineRPG.instance, 17, var1, var2, var3, var4);
            }
    ...
    public static void updateFurnaceBlockState(boolean var0, World var1, int var2, int var3, int var4)
    {
        ...
        if (var0)
        {
            var1.setBlockWithNotify(var2, var3, var4, DivineRPG.iceikaFurnaceOn.blockID);
        }
        else
        {
            var1.setBlockWithNotify(var2, var3, var4, DivineRPG.iceikaFurnace.blockID);
        }
    ...
    public void breakBlock(World var1, int var2, int var3, int var4, int var5, int var6)
    {
        ...
        {
            TileEntityCoalStoneFurnace var7 = (TileEntityCoalStoneFurnace)var1.getBlockTileEntity(var2, var3, var4);
