...
public class WorldGenLayer3SmallTree extends WorldGenerator
{
    ...
    double branchDensity = 0.9D;
    double branchSlope = 0.681D;
    double scaleWidth = 4.0D;
    double leafDensity = 5.262D;
    int trunkSize = 1;
    int heightLimitLimit = 13;
    int leafDistanceLimit = 2;
    int[][] leafNodes;

    public WorldGenLayer3SmallTree(boolean var1)
    {
        super(var1);
    }
