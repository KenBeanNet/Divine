...
public class ItemArmorUltima extends ItemArmor implements ISpecialArmor
{
    public ItemArmorUltima(int var1, EnumArmorMaterial var2, int var3, int var4)
    {
    ...
    {
        return new ISpecialArmor.ArmorProperties(0, 0.2075D, 50000);
    }
    ...
    {
        var3.add("20.75% Damage Reduction");
        var3.add("Infinite Uses");
        var3.add("Full set: Adds 24 Melee Damage");
    }
}
