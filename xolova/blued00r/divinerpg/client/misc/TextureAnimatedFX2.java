...
public class TextureAnimatedFX2 extends ModTextureAnimation
{
    public TextureAnimatedFX2(String var1, int var2) throws IOException
    {
    ...
    {
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, var1.getTexture("/Xolovon4.png"));
    }
}
