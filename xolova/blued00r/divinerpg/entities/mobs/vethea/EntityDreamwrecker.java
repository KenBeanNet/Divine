...
public class EntityDreamwrecker extends EntityMob
{
    ...
    {
        super(var1);
        this.texture = "/mob/DreamWrecker.png";
        this.moveSpeed = 0.1F;
    ...
    public void onLivingUpdate()
    {
        ...
        if (var1 != null && var1.getDistanceToEntity(this) <= 16.0F)
        {
            var1.addVelocity(Math.signum(this.posX - var1.posX) * 0.029D, 0.0D, Math.signum(this.posZ - var1.posZ) * 0.029D);
        }
    }
