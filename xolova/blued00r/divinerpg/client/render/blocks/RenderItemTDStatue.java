...
import xolova.blued00r.divinerpg.client.render.blocks.RenderItemTDStatue$1;

public class RenderItemTDStatue implements IItemRenderer
{
    private ModelTDStatue dramixAltar = new ModelTDStatue();
    ...
    {
        switch (RenderItemTDStatue$1.$SwitchMap$net$minecraftforge$client$IItemRenderer$ItemRenderType[var1.ordinal()])
        {
            case 1:
    ...
    {
        ForgeHooksClient.bindTexture("/DivineRPG/StatueTD.png", 0);
        GL11.glPushMatrix();
