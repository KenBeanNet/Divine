...
public class LightUp2 extends WorldGenerator
{
    ...
    public boolean generate(World var1, Random var2, int var3, int var4, int var5)
    {
        ...
        var1.setBlock(var3 + 4, var4 + 4, var5 + 5, DivineRPG.firelight.blockID);
        ...
        var1.setBlock(var3 + 5, var4 + 4, var5 + 6, DivineRPG.firelight.blockID);
        var1.setBlock(var3 + 5, var4 + 5, var5 + 5, DivineRPG.firelight.blockID);
        var1.setBlock(var3 + 6, var4 + 4, var5 + 5, DivineRPG.firelight.blockID);
        return true;
    }
}
