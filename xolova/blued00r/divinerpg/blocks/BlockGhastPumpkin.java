...
public class BlockGhastPumpkin extends Block
{
    public BlockGhastPumpkin(int var1)
    {
    ...
    {
        return var1 == 1 ? 235 : (var1 == 0 ? 235 : (var1 == 3 ? this.blockIndexInTexture - 1 : this.blockIndexInTexture));
    }
