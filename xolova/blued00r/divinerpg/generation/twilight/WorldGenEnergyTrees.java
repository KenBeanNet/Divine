...
{
    static final int[] otherCoordPairs = new int[] {2, 0, 0, 1, 2, 1};
    ...
    public WorldGenEnergyTrees(boolean var1)
    {
        super(var1);
    }
    ...
    void genTreeLayer(int var1, int var2, int var3, float var4, int var5, int var6)
    {
        int var7 = (int)((double)var4 + 0.618D);
        int var8 = otherCoordPairs[var5];
        int var9 = otherCoordPairs[var5 + 3];
    ...
    void generateLeafNode(int var1, int var2, int var3)
    {
        ...
        for (int var5 = var2 + this.leafDistanceLimit; var4 < var5; ++var4)
        {
            ...
            this.genTreeLayer(var1, var4, var3, var6, 1, DivineRPG.energyLeaves.blockID);
        }
    }
    ...
    void placeBlockLine(int[] var1, int[] var2, int var3)
    {
        ...
        if (var4[var6] != 0)
        {
            int var7 = otherCoordPairs[var6];
            int var8 = otherCoordPairs[var6 + 3];
            byte var9;
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] var3 = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; var1 < var2; ++var1)
        {
            ...
            {
                this.placeBlockLine(var3, var5, DivineRPG.purpleWood.blockID);
            }
        }
    }
    ...
    int checkBlockLine(int[] var1, int[] var2)
    {
        ...
        {
            int var6 = otherCoordPairs[var5];
            int var7 = otherCoordPairs[var5 + 3];
            byte var8;
