...
public class ItemMysteriousClock extends Item
{
    ...
    public boolean onItemUse(ItemStack var1, EntityPlayer var2, World var3, int var4, int var5, int var6, int var7, float var8, float var9, float var10)
    {
        ...
        else
        {
            ...
            if (spawnCreature(var3, var1.getItemDamage(), (double)var4 + 0.5D, (double)var5 + var12, (double)var6 + 0.5D) && !var2.capabilities.isCreativeMode)
            {
                --var1.stackSize;
            }
    ...
    {
        Entity var8 = EntityList.createEntityByID(67, var0);

        if (var8 != null)
        {
            var8.setLocationAndAngles(var2, var4, var6, var0.rand.nextFloat() * 360.0F, 0.0F);
            var0.spawnEntityInWorld(var8);
            var0.playSoundAtEntity(var8, "mob.RPG.AncientEntitySpawn", 10.0F, 1.0F);
        }
