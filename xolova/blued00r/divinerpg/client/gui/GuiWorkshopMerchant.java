...
public class GuiWorkshopMerchant extends GuiContainer
{
    ...
    public GuiWorkshopMerchant(InventoryPlayer var1, IMerchant var2, World var3)
    {
        super(new ContainerWorkshopMerchant(var1, var2, var3));
    ...
    {
        this.fontRenderer.drawString(StatCollector.translateToLocal("Merchant"), 56, 6, 4210752);
    ...
    protected void actionPerformed(GuiButton var1)
    {
        ...
        if (var2)
        {
            ((ContainerWorkshopMerchant)this.inventorySlots).setCurrentRecipeIndex(this.currentRecipeIndex);
    ...
    {
        int var4 = this.mc.renderEngine.getTexture("/gui/WorkshopWorker.png");
