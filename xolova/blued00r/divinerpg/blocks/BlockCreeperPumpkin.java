...
public class BlockCreeperPumpkin extends Block
{
    public BlockCreeperPumpkin(int var1)
    {
    ...
    {
        return var1 == 1 ? 143 : (var1 == 0 ? 143 : (var1 == 3 ? this.blockIndexInTexture + 2 : this.blockIndexInTexture));
    }
