...
public class TileEntityGlacideSpawner extends TileEntityMobSpawner
{
    ...
    private void updateDelay()
    {
        ...
        {
            this.spawnerTags = (MobSpawnerData)WeightedRandom.getRandomItem(this.worldObj.rand, this.field_92016_e);
    ...
    public void readFromNBT(NBTTagCompound var1)
    {
        ...
        if (var1.hasKey("SpawnPotentials"))
        {
            ...
            {
                this.field_92016_e.add(new MobSpawnerData(this, (NBTTagCompound)var2.tagAt(var3)));
            }
        }
        else
        {
        ...
        {
            this.spawnerTags = new MobSpawnerData(this, var1.getCompoundTag("SpawnData"), this.mobID);
        }
        else
        {
