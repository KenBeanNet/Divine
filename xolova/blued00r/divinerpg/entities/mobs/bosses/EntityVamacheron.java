...
public class EntityVamacheron extends EntityMob implements IBossDisplayData
{
    ...
    {
        if (this.getAttackTarget() != null && Math.round(this.posX - this.getAttackTarget().posX) == 0L && Math.round(this.posY - this.getAttackTarget().posY) == 0L && Math.round(this.posZ - this.getAttackTarget().posZ) == 0L)
        {
            this.waitTick = 30;
        }
