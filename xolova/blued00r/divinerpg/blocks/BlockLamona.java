...
public class BlockLamona extends BlockFlower
{
    public BlockLamona(int var1)
    {
        super(var1, 76);
    ...
    {
        return DivineRPG.lamonaSeeds.itemID;
    }

    protected int getCropItem()
    {
        return DivineRPG.lamonaItem.itemID;
    }
    ...
    {
        return var1 == 3 ? this.getCropItem() : this.getSeedItem();
    }
