    ...
    public boolean generate(World var1, Random var2, int var3, int var4, int var5)
    {
        ...
        if (var4 >= 1 && var4 + var6 + 1 <= 256)
        {
                ...
                for (int var12 = var3 - var9; var12 <= var3 + var9 && var7; ++var12)
                {
                    for (var10 = var5 - var9; var10 <= var5 + var9 && var7; ++var10)
                    {
                        if (var8 >= 0 && var8 < 256)
                        {
                            ...
                            if (var11 != 0 && !var13.isLeaves(var1, var12, var8, var10) && var11 != DivineRPG.serenityGrass.blockID && var11 != DivineRPG.serenityDirt.blockID && !var13.isWood(var1, var12, var8, var10))
                            {
                                var7 = false;
                            }
                        }
            ...
            else
            {
                ...
                if ((var8 == DivineRPG.serenityGrass.blockID || var8 == DivineRPG.serenityDirt.blockID) && var4 < 256 - var6 - 1)
                {
                    this.setBlock(var1, var3, var4 - 1, var5, DivineRPG.serenityDirt.blockID);
                    var9 = 3;
                    byte var19 = 0;
                    int var14;
                    int var15;
                    ...
                    for (var10 = var4 - var9 + var6; var10 <= var4 + var6; ++var10)
                    {
                        ...
                        var15 = var19 + 1 - var11 / 2;

                        for (var20 = var3 - var15; var20 <= var3 + var15; ++var20)
                        {
                            var14 = var20 - var3;

                            for (int var16 = var5 - var15; var16 <= var5 + var15; ++var16)
                            {
                                int var17 = var16 - var5;
                                Block var18 = Block.blocksList[var1.getBlockId(var20, var10, var16)];

                                if ((Math.abs(var14) != var15 || Math.abs(var17) != var15 || var2.nextInt(2) != 0 && var11 != 0) && (var18 == null || var18.canBeReplacedByLeaves(var1, var20, var10, var16)))
                                {
                                    this.setBlockAndMetadata(var1, var20, var10, var16, DivineRPG.serenityLeaves.blockID, this.metaLeaves);
                                }
                            }
                        }
                    }
                    ...
                    for (var10 = 0; var10 < var6; ++var10)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(var1, var3, var4 + var10, var5, DivineRPG.yellowWood.blockID, this.metaWood);
                    ...
                    if (this.vinesGrow)
                    {
                        for (var10 = var4 - 3 + var6; var10 <= var4 + var6; ++var10)
                        {
                            ...
                            for (var20 = var3 - var15; var20 <= var3 + var15; ++var20)
                            {
                                for (var14 = var5 - var15; var14 <= var5 + var15; ++var14)
                                {
                                    var21 = Block.blocksList[var1.getBlockId(var20, var10, var14)];

                                    if (var21 != null && var21.isLeaves(var1, var20, var10, var14))
                                    {
                                        if (var2.nextInt(4) == 0 && var1.getBlockId(var20 - 1, var10, var14) == 0)
                                        {
                                            this.growVines(var1, var20 - 1, var10, var14, 8);
                                        }

                                        if (var2.nextInt(4) == 0 && var1.getBlockId(var20 + 1, var10, var14) == 0)
                                        {
                                            this.growVines(var1, var20 + 1, var10, var14, 2);
                                        }

                                        if (var2.nextInt(4) == 0 && var1.getBlockId(var20, var10, var14 - 1) == 0)
                                        {
                                            this.growVines(var1, var20, var10, var14 - 1, 1);
                                        }

                                        if (var2.nextInt(4) == 0 && var1.getBlockId(var20, var10, var14 + 1) == 0)
                                        {
                                            this.growVines(var1, var20, var10, var14 + 1, 4);
                                        }
                                    }
                                }
                            }
                            ...
                            for (var10 = 0; var10 < 2; ++var10)
                            {
                                for (var11 = 0; var11 < 4; ++var11)
                                {
                                    if (var2.nextInt(4 - var10) == 0)
                                    {
                                        ...
                                        this.setBlockAndMetadata(var1, var3 + Direction.offsetX[Direction.footInvisibleFaceRemap[var11]], var4 + var6 - 5 + var10, var5 + Direction.offsetZ[Direction.footInvisibleFaceRemap[var11]], Block.cocoaPlant.blockID, var15 << 2 | var11);
                                    }
                                }
                            }
                        }
