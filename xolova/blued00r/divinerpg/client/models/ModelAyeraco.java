...
public class ModelAyeraco extends ModelBase
{
    ...
    public void render(Entity var1, float var2, float var3, float var4, float var5, float var6, float var7)
    {
        ...
        this.WingRF.render(var7);
        this.WingLF.render(var7);
        this.WingRExtB.render(var7);
        this.WingLExtB.render(var7);
        this.WingLExtF.render(var7);
        this.WingRExtF.render(var7);
        this.WingRExt.render(var7);
        this.WingRM.render(var7);
        this.WingLM.render(var7);
        this.WingLExtM.render(var7);
        this.Mouth1.render(var7);
        this.Butt.render(var7);
    ...
    {
        this.WingRF.rotateAngleZ = MathHelper.cos(var3 * 0.1F) * (float)Math.PI * 0.15F;
        this.WingRM.rotateAngleZ = MathHelper.cos(var3 * 0.1F) * (float)Math.PI * 0.15F;
        this.WingRB.rotateAngleZ = MathHelper.cos(var3 * 0.1F) * (float)Math.PI * 0.15F;
        this.WingRExtF.rotateAngleZ = MathHelper.cos(var3 * 0.1F) * (float)Math.PI * 0.15F;
        this.WingRExt.rotateAngleZ = MathHelper.cos(var3 * 0.1F) * (float)Math.PI * 0.15F;
        this.WingRExtB.rotateAngleZ = MathHelper.cos(var3 * 0.1F) * (float)Math.PI * 0.15F;
        ...
        this.Tail2.rotateAngleX = MathHelper.cos(var3 * 0.1F) * (float)Math.PI * 0.15F;
        this.Tail3.rotateAngleX = MathHelper.cos(var3 * 0.1F) * (float)Math.PI * 0.15F;
    }
}
