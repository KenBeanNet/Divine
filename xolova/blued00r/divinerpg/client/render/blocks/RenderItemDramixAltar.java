...
import xolova.blued00r.divinerpg.client.render.blocks.RenderItemDramixAltar$1;

public class RenderItemDramixAltar implements IItemRenderer
{
    private ModelDramixAltar dramixAltar = new ModelDramixAltar(0.0625F);
    ...
    {
        switch (RenderItemDramixAltar$1.$SwitchMap$net$minecraftforge$client$IItemRenderer$ItemRenderType[var1.ordinal()])
        {
            case 1:
