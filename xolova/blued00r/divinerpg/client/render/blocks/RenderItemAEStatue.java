...
import xolova.blued00r.divinerpg.client.render.blocks.RenderItemAEStatue$1;

public class RenderItemAEStatue implements IItemRenderer
{
    private ModelAEStatue dramixAltar = new ModelAEStatue();
    ...
    {
        switch (RenderItemAEStatue$1.$SwitchMap$net$minecraftforge$client$IItemRenderer$ItemRenderType[var1.ordinal()])
        {
            case 1:
    ...
    {
        ForgeHooksClient.bindTexture("/DivineRPG/StatueAE.png", 0);
        GL11.glPushMatrix();
