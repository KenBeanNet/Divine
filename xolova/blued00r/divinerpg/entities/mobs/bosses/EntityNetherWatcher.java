...
public class EntityNetherWatcher extends EntityFlying implements IMob, IBossDisplayData
{
    ...
    {
        return DivineRPG.netheriteBar.itemID;
    }
    ...
    {
        this.dropItem(DivineRPG.netheriteBar.itemID, 100);
        int var3 = this.rand.nextInt(4);
        this.dropItem(DivineRPG.blueFireStone.itemID, 1);
        ...
        {
            this.dropItem(DivineRPG.WatcherStatue.blockID, 1);
        }
    }
