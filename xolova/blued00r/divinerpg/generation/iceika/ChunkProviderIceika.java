...
public class ChunkProviderIceika implements IChunkProvider
{
    ...
    public void populate(IChunkProvider var1, int var2, int var3)
    {
        ...
        if (TerrainGen.populate(var1, this.worldObj, this.rand, var2, var3, var11, PopulateChunkEvent.Populate.EventType.LAKE) && !var11 && this.rand.nextInt(4) == 0)
        {
        ...
        WorldGenGiantTree var29 = new WorldGenGiantTree(true);

        for (int var17 = 0; var17 < 14; ++var17)
        {
            int var16 = var4 + this.rand.nextInt(16);
            int var19 = var5 + this.rand.nextInt(16);
            int var18 = this.worldObj.getHeightValue(var16, var19);
            var29.generate(this.worldObj, this.rand, var16, var18, var19);
        }
