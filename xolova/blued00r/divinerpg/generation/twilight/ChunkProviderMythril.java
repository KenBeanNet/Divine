...
public class ChunkProviderMythril implements IChunkProvider
{
    ...
    public void populate(IChunkProvider var1, int var2, int var3)
    {
        ...
        {
            int var14 = var4 + this.rand.nextInt(16);
            int var15 = this.rand.nextInt(250);
        ...
        {
            var18 = var4 + this.rand.nextInt(16);
            var21 = var5 + this.rand.nextInt(16);
            int var20 = this.worldObj.getTopSolidOrLiquidBlock(var18, var21);
        ...
        for (var19 = 0; var19 < 7; ++var19)
        {
            ...
            var21 = var5 + this.rand.nextInt(16);
            short var22 = 128;
            var17.generate(this.worldObj, this.rand, var18, var22, var21);
        }
