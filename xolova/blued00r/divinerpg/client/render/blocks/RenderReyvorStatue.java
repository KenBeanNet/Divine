...
{
    private ModelReyvorStatue modelAltar = new ModelReyvorStatue();

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        this.renderAModelAt((TileEntityReyvorStatue)var1, var2, var4, var6, var8);
    }

    public void renderAModelAt(TileEntityReyvorStatue var1, double var2, double var4, double var6, float var8)
    {
        GL11.glPushMatrix();
