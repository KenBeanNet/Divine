...
public class ChunkProviderAzurite implements IChunkProvider
{
    ...
    public void populate(IChunkProvider var1, int var2, int var3)
    {
        ...
        for (var13 = 0; var13 < 15; ++var13)
        {
            ...
            int var16 = var5 + this.rand.nextInt(16);
        ...
        for (int var19 = 0; var19 < 14; ++var19)
        {
            ...
            int var21 = var5 + this.rand.nextInt(16);
            int var20 = this.worldObj.getHeightValue(var18, var21);
        ...
        for (int var22 = 0; var22 < 24; ++var22)
        {
            ...
            int var24 = this.rand.nextInt(120) + 4;
            int var25 = var5 + this.rand.nextInt(16) + 8;
            (new WorldGenAzuriteWater(Block.waterMoving.blockID)).generate(this.worldObj, this.rand, var23, var24, var25);
        }
