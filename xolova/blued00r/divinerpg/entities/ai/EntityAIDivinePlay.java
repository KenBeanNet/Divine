...
public class EntityAIDivinePlay extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            {
                Vec3 var8 = net.minecraft.entity.ai.RandomPositionGenerator.findRandomTarget(this.villagerObj, 16, 3);
    ...
    public void updateTask()
    {
        ...
        {
            Vec3 var1 = net.minecraft.entity.ai.RandomPositionGenerator.findRandomTarget(this.villagerObj, 16, 3);
