...
public class EntityHusk extends EntityTameable
{
    ...
    {
        EntityHusk var2 = new EntityHusk(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal var1)
    {
        ...
        else if (!(var1 instanceof EntityHusk))
        {
            return false;
        }
        else
        {
            EntityHusk var2 = (EntityHusk)var1;
