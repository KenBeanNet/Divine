...
import xolova.blued00r.divinerpg.client.render.blocks.RenderItemDAZStatue$1;

public class RenderItemDAZStatue implements IItemRenderer
{
    private ModelDAZStatue dramixAltar = new ModelDAZStatue();
    ...
    {
        switch (RenderItemDAZStatue$1.$SwitchMap$net$minecraftforge$client$IItemRenderer$ItemRenderType[var1.ordinal()])
        {
            case 1:
    ...
    {
        ForgeHooksClient.bindTexture("/DivineRPG/StatueDex.png", 0);
        GL11.glPushMatrix();
