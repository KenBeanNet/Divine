...
public class Layer4MassiveTree extends WorldGenerator
{
    ...
    int heightLimit = 0;
    int height;
    double heightAttenuation = 0.931D;
    double branchDensity = 2.0D;
    double branchSlope = 0.481D;
    double scaleWidth = 4.0D;
    double leafDensity = 7.262D;
    int trunkSize = 2;
    int heightLimitLimit = 35;
    int leafDistanceLimit = 2;
    int[][] leafNodes;

    public Layer4MassiveTree(boolean var1)
    {
        super(var1);
    }
        ...
        for (var11[var5] = var10[var5]; var12 <= var7; ++var12)
        {
            ...
            while (var13 <= var7)
            {
                ...
                else
                {
                    ...
                    if (var16 != 0 && var16 != DivineRPG.hyrewoodLeaves.blockID)
                    {
                        ++var13;
                    }
                    else
    ...
    void generateLeafNode(int var1, int var2, int var3)
    {
        ...
        for (int var5 = var2 + this.leafDistanceLimit; var4 < var5; ++var4)
        {
            ...
            this.genTreeLayer(var1, var4, var3, var6, (byte)1, DivineRPG.hyrewoodLeaves.blockID);
        }
    }
    ...
    void generateTrunk()
    {
        ...
        this.placeBlockLine(var5, var6, DivineRPG.hyrewood.blockID);
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] var3 = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; var1 < var2; ++var1)
        {
            ...
            {
                this.placeBlockLine(var3, var5, (byte)DivineRPG.hyrewood.blockID);
            }
        }
    }
    ...
    boolean validTreeLocation()
    {
        ...
        if (var3 != DivineRPG.dreamgrass.blockID && var3 != DivineRPG.dreamdirt.blockID)
        {
            return false;
        }
        else
