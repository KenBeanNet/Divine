...
public class TextureAnimatedFX1 extends ModTextureAnimation
{
    public TextureAnimatedFX1(String var1, int var2) throws IOException
    {
    ...
    {
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, var1.getTexture("/Xolovon.png"));
    }
}
