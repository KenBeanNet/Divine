...
public class TeleporterUvite extends Teleporter
{
    protected WorldServer myWorld;

    public TeleporterUvite(WorldServer var1)
    {
        super(var1);
        this.myWorld = var1;
    }
    ...
    {
        return var1.getBlockId(var2, var3, var4) == DivineRPG.energyPortal.blockID;
    }
    ...
    private void makePortalAt(World var1, int var2, int var3, int var4)
    {
        ...
        var1.setBlock(var2 + 0, var3 + 0, var4 + 1, DivineRPG.azuriteBlock.blockID);
        var1.setBlock(var2 + 1, var3 + 0, var4 + 1, DivineRPG.azuriteBlock.blockID);
        var1.setBlock(var2 + 2, var3 + 0, var4 + 1, DivineRPG.azuriteBlock.blockID);
        var1.setBlock(var2 - 1, var3 + 0, var4 + 1, DivineRPG.azuriteBlock.blockID);
        var1.setBlock(var2 + 0, var3 + 0, var4 + 2, DivineRPG.azuriteBlock.blockID);
        var1.setBlock(var2 + 1, var3 + 0, var4 + 2, DivineRPG.azuriteBlock.blockID);
        var1.setBlock(var2 + 0, var3 + 0, var4 + 0, DivineRPG.azuriteBlock.blockID);
        var1.setBlock(var2 + 1, var3 + 0, var4 + 0, DivineRPG.azuriteBlock.blockID);
        ...
        var1.setBlock(var2 + 0, var3 + 1, var4 + 1, DivineRPG.energyPortal.blockID);
        var1.setBlock(var2 + 1, var3 + 1, var4 + 1, DivineRPG.energyPortal.blockID);
        var1.setBlock(var2 + 0, var3 + 2, var4 + 1, DivineRPG.energyPortal.blockID);
        var1.setBlock(var2 + 1, var3 + 2, var4 + 1, DivineRPG.energyPortal.blockID);
        var1.setBlock(var2 + 0, var3 + 3, var4 + 1, DivineRPG.energyPortal.blockID);
        var1.setBlock(var2 + 1, var3 + 3, var4 + 1, DivineRPG.energyPortal.blockID);
        var1.setBlock(var2 - 1, var3 + 1, var4 + 1, DivineRPG.azuriteBlock.blockID);
        var1.setBlock(var2 + 2, var3 + 1, var4 + 1, DivineRPG.azuriteBlock.blockID);
        var1.setBlock(var2 - 1, var3 + 2, var4 + 1, DivineRPG.azuriteBlock.blockID);
        var1.setBlock(var2 + 2, var3 + 2, var4 + 1, DivineRPG.azuriteBlock.blockID);
        var1.setBlock(var2 - 1, var3 + 3, var4 + 1, DivineRPG.azuriteBlock.blockID);
        var1.setBlock(var2 + 2, var3 + 3, var4 + 1, DivineRPG.azuriteBlock.blockID);
        var1.setBlock(var2 + 0, var3 + 4, var4 + 1, DivineRPG.azuriteBlock.blockID);
        var1.setBlock(var2 + 1, var3 + 4, var4 + 1, DivineRPG.azuriteBlock.blockID);
        var1.setBlock(var2 + 2, var3 + 4, var4 + 1, DivineRPG.azuriteBlock.blockID);
        var1.setBlock(var2 - 1, var3 + 4, var4 + 1, DivineRPG.azuriteBlock.blockID);
