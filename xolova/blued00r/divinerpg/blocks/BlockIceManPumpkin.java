...
public class BlockIceManPumpkin extends Block
{
    public BlockIceManPumpkin(int var1)
    {
    ...
    {
        return var1 == 1 ? 185 : (var1 == 0 ? 185 : (var1 == 3 ? this.blockIndexInTexture + 1 : this.blockIndexInTexture));
    }
