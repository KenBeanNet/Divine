...
public class GuiLeorna extends GuiContainer
{
    ...
    public GuiLeorna(InventoryPlayer var1, IMerchant var2, World var3)
    {
        super(new ContainerLeorna(var1, var2, var3));
    ...
    {
        this.fontRenderer.drawString(StatCollector.translateToLocal("Leorna"), 56, 6, 4210752);
    ...
    protected void actionPerformed(GuiButton var1)
    {
        ...
        if (var2)
        {
            ((ContainerLeorna)this.inventorySlots).setCurrentRecipeIndex(this.currentRecipeIndex);
    ...
    {
        int var4 = this.mc.renderEngine.getTexture("/gui/Leorna.png");
