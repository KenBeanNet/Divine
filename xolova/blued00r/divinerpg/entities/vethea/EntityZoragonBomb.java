...
{
    public EntityZoragonBomb(World var1)
    {
        super(var1);
    }

    public EntityZoragonBomb(World var1, EntityLiving var2)
    {
        super(var1, var2);
    }

    public EntityZoragonBomb(World var1, double var2, double var4, double var6)
    {
