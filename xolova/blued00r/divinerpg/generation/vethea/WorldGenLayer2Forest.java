...
{
    public WorldGenLayer2Forest(boolean var1)
    {
        super(var1);
    }
    ...
    public boolean generate(World var1, Random var2, int var3, int var4, int var5)
    {
        ...
        if (var4 >= 1 && var4 + var6 + 1 <= 256)
        {
            ...
            else
            {
                ...
                if ((var8 == DivineRPG.dreamgrass.blockID || var8 == DivineRPG.dreamdirt.blockID) && var4 < 256 - var6 - 1)
                {
                    this.setBlock(var1, var3, var4 - 1, var5, DivineRPG.dreamdirt.blockID);
                    int var17;
                    ...
                    for (var17 = var4 - 3 + var6; var17 <= var4 + var6; ++var17)
                    {
                        ...
                        for (var11 = var3 - var10; var11 <= var3 + var10; ++var11)
                        {
                            ...
                            for (int var14 = var5 - var10; var14 <= var5 + var10; ++var14)
                            {
                                ...
                                {
                                    this.setBlockAndMetadata(var1, var11, var17, var14, DivineRPG.firewoodLeaves.blockID, 0);
                                }
                            }
                        }
                    }
                    ...
                    for (var17 = 0; var17 < var6; ++var17)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(var1, var3, var4 + var17, var5, DivineRPG.firewood.blockID, 0);
                        }
                    }
