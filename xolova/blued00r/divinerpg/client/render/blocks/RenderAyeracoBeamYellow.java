...
public class RenderAyeracoBeamYellow extends TileEntitySpecialRenderer
{
    public void renderTileEntityBeaconAt(TileEntityAyeracoBeamYellow var1, double var2, double var4, double var6, float var8)
    {
        ...
        if (var9 > 0.0F)
        {
            ...
            this.bindTextureByName("/DivineRPG/beam2.png");
    ...
    {
        this.renderTileEntityBeaconAt((TileEntityAyeracoBeamYellow)var1, var2, var4, var6, var8);
    }
}
