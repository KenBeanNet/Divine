...
public class ContainerSuperEnchant extends Container
{
    public IInventory tableInventory = new SuperSlotEnchantmentTable(this, "Enchant", 1);
    ...
    public ContainerSuperEnchant(InventoryPlayer var1, World var2, int var3, int var4, int var5)
    {
        this.worldPointer = var2;
        this.posX = var3;
        this.posY = var4;
        this.posZ = var5;
        this.addSlotToContainer(new SuperSlotEnchantment(this, this.tableInventory, 0, 25, 47));
        int var6;
        ...
        if (var1 == this.tableInventory)
        {
            ...
            if (var2 != null && var2.isItemEnchantable())
            {
                ...
                if (!this.worldPointer.isRemote)
                {
                    ...
                    {
                        this.enchantLevels[var4] = EnchantmentHelper.calcItemStackEnchantability(this.rand, var4, var6, var2);
                    }
    ...
    {
        return this.worldPointer.getBlockId(this.posX, this.posY, this.posZ) != DivineRPG.superEnchantMentTable.blockID ? false : var1.getDistanceSq((double)this.posX + 0.5D, (double)this.posY + 0.5D, (double)this.posZ + 0.5D) <= 64.0D;
    }
