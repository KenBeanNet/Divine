...
public class BlockPortalIceika extends BlockBreakable
{
    ...
    public BlockPortalIceika(int var1, int var2)
    {
        ...
        if (!var1.isRemote)
        {
            if (this.firetick == this.firemax && this.firemax != 0)
            {
                if (var5 instanceof EntityPlayerMP)
                {
                    ...
                    {
                        if (var7.dimension != 11)
                        {
                            var7.addStat(AchievementPageDivineRPG.frozenLand, 1);
                            ...
                            var7.mcServer.getConfigurationManager().transferPlayerToDimension(var7, 11, new TeleporterIceika(var7.mcServer.worldServerForDimension(11)));
                        }
                        else
                        {
                            var7.mcServer.getConfigurationManager().transferPlayerToDimension(var7, 0, new TeleporterIceika(var7.mcServer.worldServerForDimension(0)));
                        }
                    }
                }
