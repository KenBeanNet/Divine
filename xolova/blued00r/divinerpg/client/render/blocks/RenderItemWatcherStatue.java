...
import xolova.blued00r.divinerpg.client.render.blocks.RenderItemWatcherStatue$1;

public class RenderItemWatcherStatue implements IItemRenderer
{
    private ModelWatcherStatue dramixAltar = new ModelWatcherStatue();
    ...
    {
        switch (RenderItemWatcherStatue$1.$SwitchMap$net$minecraftforge$client$IItemRenderer$ItemRenderType[var1.ordinal()])
        {
            case 1:
    ...
    private void renderCalcinator(float var1, float var2, float var3)
    {
        ...
        GL11.glPushMatrix();
        GL11.glTranslatef(var1, var2 + 0.5F, var3 + 0.8F);
        GL11.glScalef(1.0F, -1.0F, -1.0F);
        GL11.glTranslatef(0.5F, -0.5F, 0.5F);
        GL11.glPushMatrix();
        this.dramixAltar.render(0.06F);
        GL11.glPopMatrix();
        GL11.glPopMatrix();
    }
}
