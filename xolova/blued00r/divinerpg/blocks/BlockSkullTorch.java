...
import xolova.blued00r.divinerpg.client.particles.EntityWhiteFlameFX;

public class BlockSkullTorch extends BlockTorch
{
    public BlockSkullTorch(int var1, int var2)
    {
        super(var1, var2);
    }
    ...
    public void randomDisplayTick(World var1, int var2, int var3, int var4, Random var5)
    {
        ...
        if (this.blockID == DivineRPG.skullTorch.blockID)
        {
            EntityWhiteFlameFX var17;

            if (var6 == 1)
            {
                var1.spawnParticle("smoke", var7 - var15, var9 + var13, var11, 0.0D, 0.0D, 0.0D);
                var17 = new EntityWhiteFlameFX(var1, var7 - var15, var9 + var13, var11, 0.0D, 0.0D, 0.0D);
            ...
            else if (var6 == 3)
            {
                ...
                var17 = new EntityWhiteFlameFX(var1, var7, var9 + var13, var11 - var15, 0.0D, 0.0D, 0.0D);
                FMLClientHandler.instance().getClient().effectRenderer.addEffect(var17, var17);
            }
            else if (var6 == 4)
            {
            ...
            else
            {
                ...
                var17 = new EntityWhiteFlameFX(var1, var7, var9, var11, 0.0D, 0.0D, 0.0D);
                FMLClientHandler.instance().getClient().effectRenderer.addEffect(var17, var17);
            }
        }
    }
