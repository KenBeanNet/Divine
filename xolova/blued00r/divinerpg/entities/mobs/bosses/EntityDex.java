...
public class EntityDex extends EntityMob implements IBossDisplayData
{
    ...
    public EntityDex(World var1)
    {
        super(var1);
        this.texture = "/mob/dex.png";
    ...
    public void onLivingUpdate()
    {
        ...
        else
        {
            ...
            {
                this.attackEntitiesInList(this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.boundingBox.expand(3.0D, 2.0D, 3.0D)));
            }
    ...
    protected void collideWithEntity(Entity var1)
    {
        if (var1 instanceof EntityLiving)
        {
            ...
            var1.addVelocity(var2 / var6 * 4.0D, 0.20000000298023224D, var4 / var6 * 4.0D);
    ...
    {
        return DivineRPG.ultimaBoots.itemID;
    }
