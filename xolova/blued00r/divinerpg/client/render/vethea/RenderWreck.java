...
import xolova.blued00r.divinerpg.client.models.vethea.WreckForm2;
import xolova.blued00r.divinerpg.client.models.vethea.WreckForm3;
...
public class RenderWreck extends RenderLiving
{
    ...
    public void renderWreck(EntityWreck var1, double var2, double var4, double var6, float var8, float var9)
    {
        ...
        {
            this.mainModel = this.form2;
        }
        else if (EntityWreck.stage == 2)
        {
            this.mainModel = this.form3;
        }
