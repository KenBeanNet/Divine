...
public class EntityVermsillion extends EntityTameable
{
    ...
    {
        super(var1);
        this.texture = "/mob/Vermsillion.png";
    ...
    protected void updateAITasks()
    {
        ...
        {
            --this.waitTick;
            this.moveEntityWithHeading(0.0F, this.moveSpeed);
        }
    ...
    public boolean interact(EntityPlayer var1)
    {
        ...
        else if (var2 != null && var2.itemID == DivineRPG.fyrossom.itemID && !this.isAngry())
        {
            if (!var1.capabilities.isCreativeMode)
            {
                --var2.stackSize;
