...
public class ContainerOceanfireFurnace extends Container
{
    private TileEntityOceanfireFurnace furnace;
    private int lastCookTime = 0;
    private int lastBurnTime = 0;
    private int lastItemBurnTime = 0;

    public ContainerOceanfireFurnace(InventoryPlayer var1, TileEntityOceanfireFurnace var2)
    {
        this.furnace = var2;
    ...
    public ItemStack transferStackInSlot(EntityPlayer var1, int var2)
    {
        ...
        if (var4 != null && var4.getHasStack())
        {
            ...
            else if (var2 != 1 && var2 != 0)
            {
                ...
                else if (TileEntityOceanfireFurnace.isItemFuel(var5))
                {
