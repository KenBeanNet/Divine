...
public class ItemArmorDense extends ItemArmor implements ISpecialArmor
{
    public ItemArmorDense(int var1, EnumArmorMaterial var2, int var3, int var4)
    {
    ...
    {
        var3.add("20% Damage Reduction");
        var3.add("Infinite Uses");
        var3.add("Full set: Night Vision");
    }
}
