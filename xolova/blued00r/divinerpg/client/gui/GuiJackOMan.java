...
public class GuiJackOMan extends GuiContainer
{
    ...
    {
        this.fontRenderer.drawString(StatCollector.translateToLocal("Jack-O-Man"), 56, 6, 4210752);
    ...
    {
        int var4 = this.mc.renderEngine.getTexture("/gui/JackOMan.png");
