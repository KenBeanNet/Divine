...
public class WorldGenLayer2BigTree extends WorldGenerator
{
    ...
    int heightLimit = 0;
    int height;
    double heightAttenuation = 0.681D;
    double branchDensity = 2.0D;
    double branchSlope = 0.681D;
    double scaleWidth = 1.0D;
    double leafDensity = 1.0D;
    int trunkSize = 1;
    int heightLimitLimit = 18;
    int leafDistanceLimit = 4;
    int[][] leafNodes;

    public WorldGenLayer2BigTree(boolean var1)
    {
        super(var1);
    }
        ...
        for (var11[var5] = var10[var5]; var12 <= var7; ++var12)
        {
            ...
            while (var13 <= var7)
            {
                ...
                else
                {
                    ...
                    if (var16 != 0 && var16 != DivineRPG.firewoodLeaves.blockID)
                    {
                        ++var13;
                    }
                    else
    ...
    void generateLeafNode(int var1, int var2, int var3)
    {
        ...
        for (int var5 = var2 + this.leafDistanceLimit; var4 < var5; ++var4)
        {
            ...
            this.genTreeLayer(var1, var4, var3, var6, (byte)1, DivineRPG.firewoodLeaves.blockID);
        }
    }
    ...
    void generateTrunk()
    {
        ...
        this.placeBlockLine(var5, var6, DivineRPG.firewood.blockID);
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] var3 = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; var1 < var2; ++var1)
        {
            ...
            {
                this.placeBlockLine(var3, var5, (byte)DivineRPG.firewood.blockID);
            }
        }
    }
    ...
    boolean validTreeLocation()
    {
        ...
        if (var3 != DivineRPG.dreamdirt.blockID && var3 != DivineRPG.dreamgrass.blockID)
        {
            return false;
        }
        else
