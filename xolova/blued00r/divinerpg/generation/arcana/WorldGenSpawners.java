...
public class WorldGenSpawners extends WorldGenerator
{
    private int minableBlockId;
    private int minableBlockMeta;
    private int numberOfBlocks;

    public WorldGenSpawners(int var1, int var2)
    {
    ...
    public WorldGenSpawners(int var1, int var2, int var3)
    {
        this(var1, var3);
                    ...
                    for (int var41 = var33; var41 <= var36; ++var41)
                    {
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D)
                        {
                            for (int var44 = var34; var44 <= var37; ++var44)
                            {
                                ...
                                if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && var47 != null)
                                {
