...
public class TileEntityExtractinator extends TileEntityFurnace implements IInventory, ISidedInventory
{
    ...
    {
        return this.furnaceCookTime * var1 / 100;
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                var2 = true;
                BlockExtractinator.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack var1 = ExtractorRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
    ...
    public static int getItemBurnTime(ItemStack var0)
    {
        ...
        else
        {
            ...
            return var1 == DivineRPG.collector.itemID ? 100 : GameRegistry.getFuelValue(var0);
        }
    }
