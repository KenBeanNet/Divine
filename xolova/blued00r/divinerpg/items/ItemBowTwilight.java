...
public class ItemBowTwilight extends ItemBow
{
    private int lastDamage = -1;

    public ItemBowTwilight(int var1)
    {
        super(var1);
        this.setMaxDamage(-1);
    ...
    public void onPlayerStoppedUsing(ItemStack var1, World var2, EntityPlayer var3, int var4)
    {
        ...
        if (var5 || var3.inventory.hasItem(DivineRPG.furyArrow.itemID))
        {
            ...
            if ((double)var7 < 0.010000000149011612D)
            {
                return;
            }
    ...
    {
        var3.add("20 Ranged Damage");
        var3.add("Ammo: Fury Arrow");
        var3.add("5 Times Faster");
    }
}
