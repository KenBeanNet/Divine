...
public class ItemDualSpawner extends Item
{
    public static int bossSummoned;
    private World worldObj;

    public ItemDualSpawner(int var1)
    {
        super(var1);
        this.maxStackSize = 1;
    }
    ...
    public boolean onItemUse(ItemStack var1, EntityPlayer var2, World var3, int var4, int var5, int var6, int var7, float var8, float var9, float var10)
    {
        ...
        else
        {
            ...
            if (var2 instanceof EntityPlayerMP)
            {
                ...
                {
                    var2.addStat(AchievementPageDivineRPG.tenHeadsIsBetterThanOne, 1);
                    --var1.stackSize;
                }
            }
    ...
    {
        Entity var8 = EntityList.createEntityByID(115, var0);
        Entity var9 = EntityList.createEntityByID(116, var0);
        ...
        if (var8 != null && var0.getBiomeGenForCoords((int)var2, (int)var6) == DivineRPG.denseBiome)
        {
            ...
            var0.playSoundAtEntity(var8, "mob.RPG.DensosReyvorSpawn", 10.0F, 1.0F);
        }
