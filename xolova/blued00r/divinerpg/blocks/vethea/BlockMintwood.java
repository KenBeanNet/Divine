...
public class BlockMintwood extends Block
{
    public BlockMintwood(int var1)
    {
    ...
    public void breakBlock(World var1, int var2, int var3, int var4, int var5, int var6)
    {
        ...
        if (var1.checkChunksExist(var2 - var8, var3 - var8, var4 - var8, var2 + var8, var3 + var8, var4 + var8))
        {
            ...
            {
                for (var10 = -var7; var10 <= var7; ++var10)
                {
        ...
        var10 = var14.nextInt(5);

        if (var10 == 1)
        {
            EntityEnt var13 = new EntityEnt(var1);
            var13.setLocationAndAngles((double)var2, (double)var3, (double)var4, 0.0F, 0.0F);
    ...
    public int getBlockTextureFromSideAndMetadata(int var1, int var2)
    {
        int var3 = var2 & 12;
        int var4 = var2 & 3;
        return var3 == 0 && (var1 == 1 || var1 == 0) ? 159 : (var3 == 4 && (var1 == 5 || var1 == 4) ? 159 : (var3 == 8 && (var1 == 2 || var1 == 3) ? 159 : 157));
    }
