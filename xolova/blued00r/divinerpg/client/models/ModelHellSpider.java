...
public class ModelHellSpider extends ModelBase
{
    ...
    public ModelHellSpider()
    {
        ...
        this.Head.addBox(4.0F, -4.0F, -2.0F, 1, 4, 2);
        ...
        this.RearEnd.addBox(-5.0F, -4.0F, -6.0F, 10, 8, 12);
        this.RearEnd.setRotationPoint(0.0F, 16.0F, 9.0F);
        ...
        this.Shape1 = new ModelRenderer(this, 15, 9);
        this.Shape1.addBox(0.0F, 1.0F, 0.0F, 2, 9, 1);
        this.Shape1.setRotationPoint(-1.0F, 6.0F, 13.0F);
        this.Shape1.setTextureSize(64, 32);
        this.Shape1.mirror = true;
        this.setRotation(this.Shape1, -0.4363323F, 0.0F, 0.0F);
        this.Shape2 = new ModelRenderer(this, 15, 9);
        this.Shape2.addBox(0.0F, 1.0F, 0.0F, 2, 7, 1);
        this.Shape2.setRotationPoint(-1.0F, 6.0F, 1.0F);
        this.Shape2.setTextureSize(64, 32);
        this.Shape2.mirror = true;
        this.setRotation(this.Shape2, -0.4363323F, 0.0F, 0.0F);
        this.Shape3 = new ModelRenderer(this, 15, 9);
        this.Shape3.addBox(0.0F, 1.0F, 0.0F, 2, 7, 1);
        this.Shape3.setRotationPoint(-1.0F, 6.0F, 5.0F);
        this.Shape3.setTextureSize(64, 32);
        this.Shape3.mirror = true;
        this.setRotation(this.Shape3, -0.4363323F, 0.0F, 0.0F);
        this.Shape4 = new ModelRenderer(this, 15, 9);
        this.Shape4.addBox(0.0F, 1.0F, 0.0F, 2, 12, 1);
        this.Shape4.setRotationPoint(-1.0F, 6.0F, 9.0F);
        this.Shape4.setTextureSize(64, 32);
        this.Shape4.mirror = true;
        this.setRotation(this.Shape4, -0.4363323F, 0.0F, 0.0F);
        this.Headp2 = new ModelRenderer(this, 32, 4);
        this.Headp2.addBox(-4.0F, -4.0F, -8.0F, 8, 8, 8);
        this.Headp2.setRotationPoint(0.0F, 16.0F, -3.0F);
        this.Headp2.setTextureSize(64, 32);
        this.Headp2.mirror = true;
        this.setRotation(this.Headp2, 0.0F, 0.0F, 0.0F);
        this.Headp3 = new ModelRenderer(this, 32, 4);
        this.Headp3.addBox(4.0F, -4.0F, -8.0F, 1, 2, 8);
        this.Headp3.setRotationPoint(0.0F, 12.0F, -3.0F);
        this.Headp3.setTextureSize(64, 32);
        this.Headp3.mirror = true;
        this.setRotation(this.Headp3, 0.0F, 0.0F, 0.0F);
        this.Headp4 = new ModelRenderer(this, 32, 16);
        this.Headp4.addBox(-5.0F, -4.0F, -2.0F, 1, 4, 2);
        this.Headp4.setRotationPoint(0.0F, 14.0F, -3.0F);
        this.Headp4.setTextureSize(64, 32);
        this.Headp4.mirror = true;
        this.setRotation(this.Headp4, 0.0F, 0.0F, 0.0F);
        this.Headp5 = new ModelRenderer(this, 32, 4);
        this.Headp5.addBox(-5.0F, -4.0F, -8.0F, 1, 2, 8);
        this.Headp5.setRotationPoint(0.0F, 12.0F, -3.0F);
