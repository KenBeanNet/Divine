...
public class BlockSpiderPumpkin extends Block
{
    public BlockSpiderPumpkin(int var1)
    {
    ...
    {
        return var1 == 1 ? 176 : (var1 == 0 ? 176 : (var1 == 3 ? this.blockIndexInTexture + 1 : this.blockIndexInTexture));
    }
