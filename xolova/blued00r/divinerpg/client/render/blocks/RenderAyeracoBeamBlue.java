...
public class RenderAyeracoBeamBlue extends TileEntitySpecialRenderer
{
    public void renderTileEntityBeaconAt(TileEntityAyeracoBeamBlue var1, double var2, double var4, double var6, float var8)
    {
        ...
        if (var9 > 0.0F)
        {
            ...
            this.bindTextureByName("/DivineRPG/beam4.png");
    ...
    {
        this.renderTileEntityBeaconAt((TileEntityAyeracoBeamBlue)var1, var2, var4, var6, var8);
    }
}
