...
{
    private static final ItemStack defaultHeldItem = new ItemStack(DivineRPG.icicleBow, 1);
    ...
    public EntityFrostArcher(World var1)
    {
        ...
        this.tasks.addTask(4, new EntityAIArrowAttack(this, this.moveSpeed, 2, 10.0F));
