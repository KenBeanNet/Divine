...
public class RenderAyeracoBeamPurple extends TileEntitySpecialRenderer
{
    public void renderTileEntityBeaconAt(TileEntityAyeracoBeamPurple var1, double var2, double var4, double var6, float var8)
    {
        ...
        if (var9 > 0.0F)
        {
            ...
            this.bindTextureByName("/DivineRPG/beam5.png");
    ...
    {
        this.renderTileEntityBeaconAt((TileEntityAyeracoBeamPurple)var1, var2, var4, var6, var8);
    }
}
