...
public class ItemGognisahr extends ItemSwordXolovon
{
    private int weaponDamage;
    private final EnumToolMaterial field_40439_b;

    public ItemGognisahr(int var1, EnumToolMaterial var2)
    {
        super(var1, var2);
    ...
    public ItemStack onItemRightClick(ItemStack var1, World var2, EntityPlayer var3)
    {
        ...
        if (var3.getHealth() < 20)
        {
            var3.setEntityHealth(var3.getHealth() + 1);
        }
