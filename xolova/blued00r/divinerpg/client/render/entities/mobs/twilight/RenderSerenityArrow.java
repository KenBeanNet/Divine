...
public class RenderSerenityArrow extends Render
{
    public void renderArrow(EntitySerenityArrow var1, double var2, double var4, double var6, float var8, float var9)
    {
        this.loadTexture("/item/azuritearrow.png");
        GL11.glPushMatrix();
    ...
    {
        this.renderArrow((EntitySerenityArrow)var1, var2, var4, var6, var8, var9);
    }
}
