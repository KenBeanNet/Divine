...
import xolova.blued00r.divinerpg.entities.mobs.bosses.EntityAyeraco;

public class RenderAyeraco extends RenderLiving
{
    private float scale;

    public RenderAyeraco(ModelBase var1, float var2, float var3)
    {
