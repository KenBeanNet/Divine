...
public class TeleporterArcana extends Teleporter
{
    ...
    {
        return var1.getBlockId(var2, var3, var4) == DivineRPG.arcanaPortal.blockID;
    }
    ...
    private void makePortalAt(World var1, int var2, int var3, int var4)
    {
        ...
        var1.setBlockWithNotify(var2, var3, var4, DivineRPG.arcanaPortalFrame.blockID);
        var1.setBlockWithNotify(var2, var3, var4 + 1, DivineRPG.arcanaPortalFrame.blockID);
        var1.setBlockWithNotify(var2, var3, var4 + 2, DivineRPG.arcanaPortalFrame.blockID);
        var1.setBlockWithNotify(var2 + 1, var3, var4 + 3, DivineRPG.arcanaPortalFrame.blockID);
        var1.setBlockWithNotify(var2 + 2, var3, var4 + 3, DivineRPG.arcanaPortalFrame.blockID);
        var1.setBlockWithNotify(var2 + 3, var3, var4 + 3, DivineRPG.arcanaPortalFrame.blockID);
        var1.setBlockWithNotify(var2 + 4, var3, var4, DivineRPG.arcanaPortalFrame.blockID);
        var1.setBlockWithNotify(var2 + 4, var3, var4 + 1, DivineRPG.arcanaPortalFrame.blockID);
        var1.setBlockWithNotify(var2 + 4, var3, var4 + 2, DivineRPG.arcanaPortalFrame.blockID);
        var1.setBlockWithNotify(var2 + 1, var3, var4 - 1, DivineRPG.arcanaPortalFrame.blockID);
        var1.setBlockWithNotify(var2 + 2, var3, var4 - 1, DivineRPG.arcanaPortalFrame.blockID);
        var1.setBlockWithNotify(var2 + 3, var3, var4 - 1, DivineRPG.arcanaPortalFrame.blockID);
