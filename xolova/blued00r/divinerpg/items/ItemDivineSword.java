...
public class ItemDivineSword extends ItemSwordXolovon
{
    private int weaponDamage;
    private final EnumToolMaterial field_40439_b;

    public ItemDivineSword(int var1, EnumToolMaterial var2)
    {
        super(var1, var2);
    ...
    {
        var3.addStat(AchievementPageDivineRPG.divinePlan, 1);
    }
