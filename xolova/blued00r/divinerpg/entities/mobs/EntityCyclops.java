...
public class EntityCyclops extends EntityMob
{
    ...
    public void onUpdate()
    {
        ...
        {
            this.worldObj.playSoundAtEntity(this, "mob.RPG.cyclops", this.getSoundVolume() * 2.0F, ((this.rand.nextFloat() - this.rand.nextFloat()) * 0.2F + 1.0F) * 1.8F);
        }
    ...
    {
        this.dropItem(DivineRPG.glowingGem.itemID, 1);
    }
