...
public class EntityFirefly extends EntityThrowable implements IProjectile
{
    ...
    public EntityFirefly(World var1)
    {
        super(var1);
    ...
    public EntityFirefly(World var1, EntityLiving var2)
    {
        super(var1);
        this.thrower = var2;
        this.setSize(0.25F, 0.25F);
    ...
    public EntityFirefly(World var1, double var2, double var4, double var6)
    {
        super(var1);
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            if (this.target != null)
            {
                if (this.posX - this.target.posX < 0.1D - (double)this.target.width)
                {
                    this.motionX = 0.20000000298023224D;
                }
                else if (this.posX - this.target.posX > (double)this.target.width - 0.1D)
                {
                    this.motionX = -0.20000000298023224D;
                }
                else
                ...
                if (this.posY - this.target.posY + (double)(this.target.height / 2.0F) < 0.1D)
                {
                    this.motionY = 0.20000000298023224D;
                }
                else if (this.posY - this.target.posY + (double)(this.target.height / 2.0F) > (double)this.target.height - 0.1D)
                {
                    this.motionY = -0.20000000298023224D;
                }
                else
                ...
                if (this.posZ - this.target.posZ < 0.1D - (double)this.target.width)
                {
                    this.motionZ = 0.20000000298023224D;
                }
                else if (this.posZ - this.target.posZ > (double)this.target.width - 0.1D)
                {
                    this.motionZ = -0.20000000298023224D;
                }
                else
    ...
    protected void onImpact(MovingObjectPosition var1)
    {
        ...
        {
            var1.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, this.getThrower()), 10);
        }
    ...
    private EntityLiving getNewTarget()
    {
        ...
        for (int var13 = 0; var13 < var12.size(); ++var13)
        {
            ...
            if (var14 == null || var14 == this.thrower)
            {
                var17 = true;
            }

            if ((var7 < 0.0D || var15 < var7 * var7) && (var9 == -1.0D || var15 < var9) && var14 instanceof EntityLiving && !var17)
            {
                var9 = var15;
