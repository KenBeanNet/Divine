...
public class EntityBlueFlameFX extends EntityFX
{
    ...
    public EntityBlueFlameFX(World var1, double var2, double var4, double var6, double var8, double var10, double var12)
    {
        ...
        this.particleBlue = 10.0F;
        this.particleMaxAge = (int)(8.0D / (Math.random() * 0.8D + 0.2D)) + 4;
        this.noClip = true;
        this.setParticleTextureIndex(48);
        ForgeHooksClient.bindTexture(this.getTexture(), 0);
    }
