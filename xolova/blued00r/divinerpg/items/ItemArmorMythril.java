...
public class ItemArmorMythril extends ItemArmor implements ISpecialArmor
{
    public ItemArmorMythril(int var1, EnumArmorMaterial var2, int var3, int var4)
    {
    ...
    public void addInformation(ItemStack var1, EntityPlayer var2, List var3, boolean var4)
    {
        ...
        var3.add("Full set: 5x Jump Height");
