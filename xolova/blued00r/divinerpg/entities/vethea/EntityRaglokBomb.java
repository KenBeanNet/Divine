...
public class EntityRaglokBomb extends Entity
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityRaglokBomb(World var1)
    {
        super(var1);
        this.setSize(0.5F, 0.5F);
    }

    public EntityRaglokBomb(World var1, double var2, double var4, double var6, boolean var8)
    {
        super(var1);
        this.setSize(0.5F, 0.5F);
    ...
    public EntityRaglokBomb(World var1, EntityLiving var2, EntityLiving var3, float var4, float var5, boolean var6)
    {
        super(var1);
    ...
    public EntityRaglokBomb(World var1, EntityLiving var2, float var3)
    {
        super(var1);
        this.shootingEntity = var2;
    ...
    public static DamageSource causeSerenityArrowDamage(EntityRaglokBomb var0, Entity var1)
    {
    ...
    public void onCollideWithPlayer(EntityPlayer var1)
    {
        ...
        {
            var1.attackEntityFrom(DamageSource.causeMobDamage((EntityLiving)this.shootingEntity), 10);
            this.setDead();
        }
