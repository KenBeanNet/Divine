...
public class ModelSeimer extends ModelBase
{
    ...
    public ModelSeimer()
    {
        ...
        this.setRotation(this.hornright2, 0.0F, -((float)Math.PI / 2F), 0.0F);
        ...
        this.setRotation(this.sensorright2, 0.0F, -((float)Math.PI / 2F), 0.0F);
        ...
        this.setRotation(this.wingleft1, 0.0F, -((float)Math.PI / 2F), 0.0F);
        ...
        this.setRotation(this.wingright2, 0.0F, -((float)Math.PI / 2F), 0.0F);
        ...
        this.setRotation(this.hornleft2, 0.0F, -((float)Math.PI / 2F), 0.0F);
        ...
        this.setRotation(this.sensorleft2, 0.0F, -((float)Math.PI / 2F), 0.0F);
    }
    ...
    public void render(Entity var1, float var2, float var3, float var4, float var5, float var6, float var7)
    {
        ...
        this.hornright2.render(var7);
        this.sensorright2.render(var7);
        this.sensorleft.render(var7);
        this.wingright.render(var7);
        this.wingleft.render(var7);
        this.wingleft1.render(var7);
        this.wingright2.render(var7);
        this.hornleft.render(var7);
        this.sensorright.render(var7);
        this.hornleft2.render(var7);
        this.sensorleft2.render(var7);
    }
