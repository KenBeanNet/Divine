...
public class RenderUndeadMiner extends RenderLiving
{
    protected ModelZombie modelBipedMain;
    protected float field_77070_b;

    public RenderUndeadMiner(ModelZombie var1, float var2)
    {
        this(var1, var2, 1.0F);
        this.modelBipedMain = var1;
    }

    public RenderUndeadMiner(ModelZombie var1, float var2, float var3)
    {
        super(var1, var2);
        this.modelBipedMain = var1;
