...
public class ChunkProviderTwilight implements IChunkProvider
{
    ...
    public void populate(IChunkProvider var1, int var2, int var3)
    {
        ...
        for (var20 = var4 + 8; var20 < var4 + 8 + 16; ++var20)
        {
            for (var21 = var5 + 8; var21 < var5 + 8 + 16; ++var21)
            {
                int var10000 = var20 - (var4 + 8);
                var10000 = var21 - (var5 + 8);
                this.worldObj.getPrecipitationHeight(var20, var21);
            }
        }
