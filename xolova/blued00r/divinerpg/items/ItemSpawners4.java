...
public class ItemSpawners4 extends Item
{
    private World worldObj;

    public ItemSpawners4(int var1)
    {
        super(var1);
        this.maxStackSize = 1;
    }
    ...
    {
        Entity var8 = EntityList.createEntityByID(122, var0);
        ...
        if (var8 != null && var0.provider.isHellWorld)
        {
            ...
            var0.playSoundAtEntity(var8, "mob.RPG.ScorcherKingSpawn", 10.0F, 1.0F);
        }
