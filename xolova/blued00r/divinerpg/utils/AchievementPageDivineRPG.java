...
{
    public static final Achievement divineInervention = (new Achievement(2002, "divineintervention", 0, 3, DivineRPG.watcherSpawn, (Achievement)null)).registerAchievement();
    ...
    public static final Achievement liesWithin = (new Achievement(2003, "lieswithin", 0, 5, DivineRPG.arcanaPortalFrame, (Achievement)null)).registerAchievement();
    public static final Achievement perfectlyCorrupted = (new Achievement(2006, "perfectlycorrupted", 5, 0, DivineRPG.superEnchantMentTable, (Achievement)null)).registerAchievement();
    ...
    public static final Achievement eyeOfEvil = (new Achievement(2010, "eyeOfEvil", 0, 0, DivineRPG.rupee, (Achievement)null)).registerAchievement();
    public static final Achievement tripleDanger = (new Achievement(2011, "tripleDanger", 2, 0, DivineRPG.purpleShard, (Achievement)null)).registerAchievement();
    ...
    public static final Achievement offKey = (new Achievement(2029, "offkey", 6, 0, DivineRPG.soundOfMusic, (Achievement)null)).registerAchievement();
    ...
    public static final Achievement mealToRemember = (new Achievement(2015, "mealToRemember", 1, 0, DivineRPG.dinner, (Achievement)null)).registerAchievement();
    ...
    public static final Achievement halloweenSpirit = (new Achievement(2018, "halloweenspirit", 4, 0, DivineRPG.scythe, (Achievement)null)).registerAchievement();
    ...
    public static final Achievement feedingOnTheFish = (new Achievement(2020, "feedingonthefish", 3, 0, DivineRPG.sharkFin, (Achievement)null)).registerAchievement();
    ...
    public static final Achievement frozenLand = (new Achievement(2022, "frozenland", 0, 1, DivineRPG.iceikaPortal, (Achievement)null)).registerAchievement();
    ...
    public static AchievementPage divinerpgpage = new AchievementPage("DivineRPG", new Achievement[] {divinePlan, divineInervention, liesWithin, friendOrFoe, tenHeadsIsBetterThanOne, perfectlyCorrupted, totalDemonization, greatBirdFire, dungeonMaster, eyeOfEvil, tripleDanger, possibilities, enrichment, hoterthanHell, mealToRemember, yuk, littleCreature, halloweenSpirit, oneLamp, feedingOnTheFish, arrowToTheKnee, frozenLand, frozenGoods, lilGift, lilTinkerin, darkAnotherDay, skyHigh, whenPigsFly, offKey, allHellLoose});
