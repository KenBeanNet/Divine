...
public class LightPost3 extends WorldGenerator
{
    ...
    public boolean generate(World var1, Random var2, int var3, int var4, int var5)
    {
        if (this.LocationIsValidSpawn(var1, var3, var4, var5) && this.LocationIsValidSpawn(var1, var3 + 2, var4, var5) && this.LocationIsValidSpawn(var1, var3 + 2, var4, var5 + 2) && this.LocationIsValidSpawn(var1, var3, var4, var5 + 2))
        {
            ...
            var1.setBlock(var3 + 1, var4 + 2, var5 + 0, DivineRPG.coalStone.blockID);
            ...
            var1.setBlock(var3 + 1, var4 + 4, var5 + 1, DivineRPG.workshopLamp.blockID);
            var1.setBlock(var3 + 2, var4 + 0, var5 + 1, DivineRPG.coalStone.blockID);
            var1.setBlock(var3 + 2, var4 + 2, var5 + 1, DivineRPG.coalStone.blockID);
            return true;
        }
        else
        {
