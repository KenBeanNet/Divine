...
public class BlockZombiePumpkin extends Block
{
    public BlockZombiePumpkin(int var1)
    {
    ...
    {
        return var1 == 1 ? 182 : (var1 == 0 ? 182 : (var1 == 3 ? this.blockIndexInTexture + 1 : this.blockIndexInTexture));
    }
