...
public class TileEntityMoonlightFurnace extends TileEntityFurnace implements IInventory, ISidedInventory
{
    ...
    public static int getItemBurnTime(ItemStack var0)
    {
        ...
        else
        {
            ...
            return var1 == DivineRPG.fireStockItem.itemID ? 2400 : GameRegistry.getFuelValue(var0);
        }
    }
