...
public class RenderFrostArcher extends RenderLiving
{
    protected ModelBiped modelBipedMain;
    protected float field_77070_b;

    public RenderFrostArcher(ModelBiped var1, float var2)
    {
        this(var1, var2, 1.0F);
        this.modelBipedMain = var1;
    }

    public RenderFrostArcher(ModelBiped var1, float var2, float var3)
    {
        super(var1, var2);
        this.modelBipedMain = var1;
    ...
    protected void renderEquippedItems(EntityLiving var1, float var2)
    {
        ...
        if (var3 != null)
        {
            ...
            else if (var3.itemID == DivineRPG.icicleBow.itemID)
            {
                var6 = 0.625F;
                GL11.glTranslatef(0.0F, 0.125F, 0.3125F);
                GL11.glRotatef(-20.0F, 0.0F, 1.0F, 0.0F);
