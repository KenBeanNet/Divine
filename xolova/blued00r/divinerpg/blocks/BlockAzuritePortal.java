            ...
            if (this.firetick == this.firemax && this.firemax != 0)
            {
                if (var5 instanceof EntityPlayerMP)
                {
                    ...
                    if (var5.ridingEntity == null && var5.riddenByEntity == null && var5 instanceof EntityPlayer)
                    {
                        ...
                        if (var7.dimension != DivineRPG.azuriteID)
                        {
                            var7.mcServer.getConfigurationManager().transferPlayerToDimension(var7, DivineRPG.azuriteID, new TeleporterAzurite(var7.mcServer.worldServerForDimension(DivineRPG.azuriteID)));
                        }
                        else
                        {
                            var7.mcServer.getConfigurationManager().transferPlayerToDimension(var7, 0, new TeleporterAzurite(var7.mcServer.worldServerForDimension(0)));
                        }
                    }
                }
