...
public class ContainerDivineMerchant extends Container
{
    ...
    public ContainerDivineMerchant(InventoryPlayer var1, IMerchant var2, World var3, int var4)
    {
        this.theMerchant = var2;
        this.theWorld = var3;
        this.merchantInventory = new DivineInventory(var1.player, var2, var4);
