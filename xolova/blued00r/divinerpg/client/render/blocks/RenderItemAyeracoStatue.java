...
import xolova.blued00r.divinerpg.client.render.blocks.RenderItemAyeracoStatue$1;

public class RenderItemAyeracoStatue implements IItemRenderer
{
    private ModelAyeracoStatue dramixAltar = new ModelAyeracoStatue();
    ...
    {
        switch (RenderItemAyeracoStatue$1.$SwitchMap$net$minecraftforge$client$IItemRenderer$ItemRenderType[var1.ordinal()])
        {
            case 1:
    ...
    {
        ForgeHooksClient.bindTexture("/DivineRPG/StatueAyeraco.png", 0);
        GL11.glPushMatrix();
