...
public class GuiVatticus extends GuiContainer
{
    ...
    {
        this.fontRenderer.drawString(StatCollector.translateToLocal("Lord Vatticus"), 56, 6, 4210752);
    ...
    protected void actionPerformed(GuiButton var1)
    {
        ...
        if (var2)
        {
            ((ContainerVatticus)this.inventorySlots).setCurrentRecipeIndex(this.currentRecipeIndex);
    ...
    {
        int var4 = this.mc.renderEngine.getTexture("/gui/LordVatticus.png");
